...
describe('Tpa.js', function () {
    it('N - internal Number class, basic sanity checks', function () {
        ...
        assert.equal(new Tpa.N().set(Math.pow(10,20)).value(),Math.pow(10,20),'Set a large value');
        var n=new Tpa.N().set(1000);
        n.reset();
        assert.equal(n.value(),0,'Reset value to be 0');
        assert.equal(n.set(Math.pow(10,20)).add(new Tpa.N().set(Math.pow(10,20))).value(),2*Math.pow(10,20),'Basic addition');
        assert.equal(n.subtract(new Tpa.N().set(Math.pow(10,20))).value(),Math.pow(10,20),'Basic subtraction');
        assert.throws(function() {n.subtract(new Tpa.N().set(Math.pow(11,20))).value()},Error,'Cannot subtract larger from smaller');
        n.set(Math.pow(10,8));
    ...
    describe('Instantiations',function() {
        ...
        it('Integer, numeric construction',function() {
            ...
            assert.throws(function() {new Tpa(NaN)},Error,'Construction with NaN should fail');
        ...
        it('Decimal, numeric construction', function() {
            ...
            assert.equal(Tpa(1.123456789,false).value(),1.123456789,'small number with 9 significant figures');
            assert.equal(Tpa(123456789.123456789,false).value(),123456789.123456789,'large number with 9 significant figures');
            ...
            assert.equal(Tpa(123456789000000000000.123456789,false).value(),123456789000000000000,'very large number with 9 significant figures - loses precision');
        });
        ...
        it('Bad format for string instantiation',function() {
            assert.throws(function() {new Tpa('1-9')},Error,'Construction with +/- not at start should fail');
            assert.throws(function() {new Tpa('+123s')},Error,'Construction with bad character should fail');
            assert.throws(function() {new Tpa('+123..0')},Error,'Construction with multiple decimal points should fail');
            assert.throws(function() {new Tpa('1.23.45')},Error,'Construction with multiple separate decimal points should fail');
            assert.throws(function() {new Tpa('+-123.0')},Error,'Construction with plus and minus sign should fail');
            assert.throws(function() {new Tpa('qwerty')},Error,'Construction bad characters should fail');
            assert.throws(function() {new Tpa('125!')},Error,'Construction with exclamation mark in numerator should fail');
            assert.throws(function() {new Tpa('125.!')},Error,'Construction with no decimals after exclamation mark should fail');
            assert.throws(function() {new Tpa('125 3')},Error,'No denominator in fraction');
            assert.throws(function() {new Tpa('125 /')},Error,'No numerator in fraction');
            assert.throws(function() {new Tpa('125 /10')},Error,'No denominator in fraction');
            assert.throws(function() {new Tpa('125 1.5/10')},Error,'Cannot have decimals in fractional numerator');
            assert.throws(function() {new Tpa('125 1/.1')},Error,'Cannot have decimals in fractional denominator');
            assert.throws(function() {new Tpa('125 3s2/12')},Error,'Bad character in fractional numerator');
            assert.throws(function() {new Tpa('125 32/121!')},Error,'Bad character in fractional denominator');
            assert.throws(function() {new Tpa('/12')},Error,'Fractional only number with no numerator');
            assert.throws(function() {new Tpa('123/')},Error,'Fractional only number with no denominator');
            assert.throws(function() {new Tpa('123.3[')},Error,'Decimal with incomplete recurring section');
            assert.throws(function() {new Tpa('123.3[]')},Error,'Decimal with empty recurring section');
            assert.throws(function() {new Tpa('123.3[123')},Error,'Decimal non terminated recurring section');
            assert.throws(function() {new Tpa('123.3[123]4')},Error,'Decimal with digits after recurring section termination');
        });
        ...
        it("Fraction string construction", function() {
            ...
            assert.equal(Tpa('100 255/256').value(),100.99609375,"Simple number with larger fraction");
            ...
            assert.throws(function() {new Tpa('0/123')},Error,'Fractional numerator cannot be 0');
            assert.throws(function() {new Tpa('123/0')},Error,'Fractional denominator cannot be 0');
    ...
    describe('Miscellaneous functions',function() {
        ...
        it('Zero, negative and positive checks', function () {
            ...
            assert.equal(Tpa(0).isPositive(),true,'isPositive for zero');
    ...
    describe('Comparisons',function() {
        it('Equals for integers', function () {
            assert.throws(function() {new Tpa(1).eq()},Error,'Must pass something into eq()');
        ...
        describe('Other comparitor functions',function() {
            it('Less than', function () {
                assert.throws(function() {new Tpa(1).lt()},Error,'Must pass something into lt()');
            ...
            it('Less than or equal', function () {
                assert.throws(function() {new Tpa(1).lte()},Error,'Must pass something into lte()');
            ...
            it('Greater than', function () {
                assert.throws(function() {new Tpa(1).gt()},Error,'Must pass something into gt()');
            ...
            it('Greater than or equal', function () {
                assert.throws(function() {new Tpa(1).gte()},Error,'Must pass something into gte()');
    ...
    describe('Addition', function () {
        it('Add various positive integers', function () {
            assert.throws(function() {new Tpa(1).add()},Error,'Must pass something into add()');
        ...
        it('Add positive and negative decimal numbers',function() {
            ...
            assert.equal(Tpa(1.36784571).add(1.2394362).value(),2.60728191,"Addition of two longer decimals");
    ...
    describe('subtraction - same tests as for addition', function () {
        it('Subtract various positive integers', function () {
            assert.throws(function() {new Tpa(1).subtract()},Error,'Must pass something into subtract()');
        ...
        it('Subtract positive and negative decimal numbers',function() {
            ...
            assert.equal(Tpa(1.36784571).subtract(1.2394362).value(),0.12840951,"Two longer decimals");
            assert.equal(Tpa(10.36784571).subtract(-9.06784571).value(),19.43569142,"Two longer decimals yielding positive");
            assert.equal(Tpa(10.36784571).subtract(-11.06784571).value(),21.43569142,"Two longer decimals yielding negative");
        });
    ...
    describe('Multiplication', function () {
        ...
        it('Larger numbers',function() {
            ...
            assert.equal(Tpa.multiply(x,y).toString(),z,'Huge muliplication');
    ...
    describe('Division', function () {
        it('Various integers', function () {
            assert.throws(function() {new Tpa(123).divide(0)},Error,'Divide by zero');
        ...
        it('Consistency',function() {
            ...
            var x=Tpa(21321432423524234234);
        ...
        it('Simplification', function() {
            ...
            n.divide(1520.674);
            assert.equal(n.simplify(1),false,'1 millisecond will not be enough time to do the job');
