/**
 * @file The helper class to store large integers for Total Precision Arithmetic
 * @author Dominic Thwaites
 * @copyright (c) 2016 Dominic Thwaites dominicthwaites@mac.com
 * @licence MIT
 */

module.exports=(/** @lends Tpa*/function() {
    'use strict';
     ...
     * In the browser version of this library this class is only accessible except via the internals of Tpa objects
     *
     ...
     *
     * @param {number|string|N} [initialValue] The initial value assigned to this number.
     ...
     * @returns {N} This number for chaining purposes
     */
     ...
     * @return {N} This number for chaining purposes
     */
     ...
     *
     * @see positivise
     * @param {N}  comparison The number to compare with this number
     ...
     *
     * @param {N} number The number to copy and make positive
     * @return {N} A new number that is the positive version of number
     */
     ...
     * Addition
     *
     * @param {N} number The number to add to this number
     * @return {N} This number for chaining purposes
     */
     ...
     * Subtraction
     *
     * @param {N} number The number to subtract from this number
     * @return {N} This number for chaining purposes
     */
     ...
     * Multiplication
     *
     * @param {N} number The number to multiply this number
     * @return {N} This number for chaining purposes
     */
     ...
     * Division
     *
     * @param {N} number The number to divide into this number
     * @return {N} The remainder. *Note:* This number is not returned, unlike most other mutation operations
     ...
     *
     * @private
     * @returns {N} An approximate square root of this number
     */
